...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#090c10] px-4 py-8">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-[#0f1117] border border-white/[0.08] rounded-2xl shadow-2xl p-6">
          ...
          {passwordMismatch && (
            <div className="mb-4 px-4 py-3 bg-red-500/10 border border-red-500/30 rounded-xl">
              <p className="text-red-400 text-sm text-center">{t('auth.register.passwordMismatch')}</p>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                disabled={isLoading}
                className={`field-input ${passwordMismatch ? 'border-red-500/60' : ''}`}
                placeholder="••••••••"
              />
            </div>
